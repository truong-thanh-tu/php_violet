...
<section class="hero-slider">
    <div class="hero-items owl-carousel">
        <div class="single-slider-item set-bg" data-setbg="../public/img/slider-1.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h1>2019</h1>
        ...
        <div class="single-slider-item set-bg" data-setbg="../public/img/slider-2.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h1>2019</h1>
        ...
        <div class="single-slider-item set-bg" data-setbg="../public/img/slider-3.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h1>2019</h1>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="single-features-ads first">
                        <img src="../public/img/icons/f-delivery.png" alt="">
                        <h4>Free shipping</h4>
                ...
                <div class="col-lg-4">
                    <div class="single-features-ads">
                        <img src="../public/img/icons/chat.png" alt="">
        ...
        <div class="row" id="product-list">
            <div class="col-lg-3 col-sm-6 mix all dresses bags">
                <div class="single-product-item">
                    ...
                    <div class="product-text">
                        <a href="detail_product.html"> <h6>Green Dress with details</h6></a>
                        <p>$22.90</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 mix all dresses bags">
                <div class="single-product-item">
                    ...
                    <div class="product-text">
                        <a href="detail_product.html"> <h6>Yellow Maxi Dress</h6></a>
                        <p>$25.90</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 mix all shoes accesories">
                <div class="single-product-item">
                    ...
                    <div class="product-text">
                        <a href="detail_product.html"><h6>One piece bodysuit</h6></a>
                        <p>$19.90</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 mix all shoes accesories">
                <div class="single-product-item">
                    ...
                    <div class="product-text">
                        <a href="detail_product.html">  <h6>Blue Dress with details</h6></a>
                        <p>$35.50</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 mix all dresses shoes">
                <div class="single-product-item">
                    <figure>
                        <img src="../public/img/products/img-5.jpg" alt=""></a>
                        <div class="p-status">new</div>
                    </figure>
                    <div class="product-text">
                        <a href="detail_product.html"><h6>Green Dress with details</h6></a>
            ...
            <div class="col-lg-3 col-sm-6 mix all dresses bags">
                <div class="single-product-item">
                    <figure>
                        <img src="../public/img/products/img-7.jpg" alt="">
                    </figure>
                    <div class="product-text">
                        <a href="detail_product.html">   <h6>One piece bodysuit</h6></a>
                        <p>$19.90</p>
